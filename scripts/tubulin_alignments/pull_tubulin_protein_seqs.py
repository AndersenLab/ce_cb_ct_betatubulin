...
ce_prot_file = 'data/raw/blast_data/20230324_blast/c_elegans/ce_all_prot_flat.fa'
cb_prot_file = 'data/raw/blast_data/20230324_blast/c_briggsae/cb_all_prot_flat.fa'
ct_prot_file = 'data/raw/blast_data/20230324_blast/c_tropicalis/ct_all_prot_flat.fa'
...
def process_protein_sequences(protein_dict, ce_prot_file, cb_prot_file, ct_prot_file, out_file):
    for key, protein_info in protein_dict.items():
        ...
        if key == 'ce':
            pull_and_rename_protein_sequence(protein_id, formal_name, ce_prot_file, out_file)
        elif key == 'cb':
            pull_and_rename_protein_sequence(protein_id, formal_name, cb_prot_file, out_file)
        elif key == 'ct':
            pull_and_rename_protein_sequence(protein_id, formal_name, ct_prot_file, out_file)
        else:
