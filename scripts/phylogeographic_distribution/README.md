...
Outputs: 
- `cb_hta_tree_plot`: Tree of C.b strains assayed for ABZ response
- `ct_hta_tree_plot`: Tree of C.t strains assayed for ABZ response

### HTA tree plots
The list of strains included in our assay are loaded from `bin/hta_strains.tsv`. The file has two columns `strain` and `species`
